...
namespace MyPrivateApp.Migrations
{
    ...
    [Migration("20260731214843_AddFieldsToFarmWorkPlaningAndCompletedFourHoursFieldsAndDeletedTodoField")]
    partial class AddFieldsToFarmWorkPlaningAndCompletedFourHoursFieldsAndDeletedTodoField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPrivateApp.Data.Models.FarmWork.FarmWorks", b =>
                {
                    ...
                    b.HasIndex("FarmWorksPlanningCompletedId");

                    b.HasIndex("FarmWorksPlanningsId");
            ...
            modelBuilder.Entity("MyPrivateApp.Data.Models.FarmWork.FarmWorksPlanning", b =>
                {
                    ...
                    b.Property<double>("ClearingHours")
                        .HasColumnType("float");

                    b.Property<double>("ForClearingHours")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("ThinHours")
                        .HasColumnType("float");

                    b.Property<double>("ToForwardHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MyPrivateApp.Data.Models.FarmWork.FarmWorks", b =>
                {
                    b.HasOne("MyPrivateApp.Data.Models.FarmWork.FarmWorksPlanningCompleted", "FarmWorksPlanningCompleted")
                        .WithMany("FarmWorks")
                        .HasForeignKey("FarmWorksPlanningCompletedId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MyPrivateApp.Data.Models.FarmWork.FarmWorksPlanning", "FarmWorksPlanning")
                        .WithMany("FarmWorks")
                        .HasForeignKey("FarmWorksPlanningsId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("FarmWorksPlanning");

                    b.Navigation("FarmWorksPlanningCompleted");
                });

            modelBuilder.Entity("MyPrivateApp.Data.Models.FarmWork.FarmWorksPlanning", b =>
                {
                    b.Navigation("FarmWorks");
                });
